## Day 15 – Networking Concepts: DNS, IP, Subnets & Ports
   ...
   ## Task 1: DNS – How Names Become IPs:
           1- what happens when you type google.com in a browser?
               ...
               2- DNS works like a phonebook: It converts the domain name (google.com) into an IP address 
                  (e.g., 142.x.x.x)       
               3- The DNS server finds the IP: It queries different servers (root → TLD → authoritative) 
